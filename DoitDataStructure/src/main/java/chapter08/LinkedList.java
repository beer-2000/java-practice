...
public class LinkedList<E> {
    ...
    public void purge(Comparator<? super E> c) {
        Node<E> pointerOuter = head;
        while (pointerOuter != null) {
            Node<E> pointerInner = pointerOuter.next;
            while (pointerInner != null) {
                if (c.compare(pointerInner.data, pointerOuter.data) == 0) {
                    remove(pointerInner);
                }
